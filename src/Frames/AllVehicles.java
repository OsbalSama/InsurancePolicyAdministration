 ...
 * @author terra
 */
public final class AllVehicles extends javax.swing.JFrame {
    ...
    public void showVehicles() {
        modelo.setRowCount(0);
        String datos[] = new Vehiculos().getDBVehicles();
        try {
            if (datos != null) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("VEHICULOS EN EL SISTEMA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllVehicles.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AllVehicles().setVisible(true);
            }
        });
    }
