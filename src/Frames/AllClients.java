...
public final class AllClients extends javax.swing.JFrame {
    ...
    public void showClients() {
        modelo.setRowCount(0);
        String datos[] = new Clientes().getDBClients();
        try {
            if (datos != null) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CLIENTES EN EL SISTEMA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllClients.class
